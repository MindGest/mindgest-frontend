...
<wrapper
  class="flex flex-col"
  style="margin:50px; float:left; width:50%; position:relative; top:10%"
>
  <div class="my-5">
    <TextDisplay
  ...
  <div class="my-5">
    <TextDisplay
      label="Hora prevista de término:"
      value="{ap.end}h"
      class="grid grid-cols-3 items-center font-bold"
    />
  </div>
...
<wrapper
  class="flex flex-col"
  style="float:right; width:20%; position:relative; top:90%; bottom:10%; right:10%"
>
